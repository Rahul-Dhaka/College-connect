...
const Top10 = () => {
  ...
  return (
    <div className=" w-full h-full border rounded-xl shadow flex flex-col overflow-hidden">
      ...
      <div className=" w-full h-full  space-x-6 overflow-x-scroll overflow-y-clip">
            <div className="w-fit h-full min-w-full flex items-center justify-around">
            {iterations.map((index:number)=>(
                <div className="relative rounded-lg flex flex-col justify-center items-center m-1 h-full w-24 border shadow ml-4 bg-white">
