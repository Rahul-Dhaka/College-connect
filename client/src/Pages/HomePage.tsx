...
const HomePage = () => {
  return (
    <div className="w-screen h-screen overflow-x-hidden fixed">
        <div className="w-full h-1/2 md:h-4/6 rounded-b-xl rounded-br-[40%] md:rounded-br-xl overflow-hidden bg-[url('/model.jpg')] bg-cover bg-center">
        ...
        <div className="w-full h-[180px] mt-5 p-1"> 
        <Top10/>
        </div>
